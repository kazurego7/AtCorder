...
namespace AtCoderTemplate {
    public class Program {
        public static void Main (string[] args) {
            ...
            var dx = tx - sx;
            var dy = ty - sy;
            var ans = Enumerable.Repeat ("U", dy)
                .Concat (Enumerable.Repeat ("R", dx))
                .Concat (Enumerable.Repeat ("D", dy))
                .Concat (Enumerable.Repeat ("L", dx))
                .Append ("L")
                .Concat (Enumerable.Repeat ("U", dy + 1))
                .Concat (Enumerable.Repeat ("R", dx + 1))
                .Append ("D")
                .Append ("R")
                .Concat (Enumerable.Repeat ("D", dy + 1))
                .Concat (Enumerable.Repeat ("L", dx + 1))
                .Append ("U")
                .Pipe (String.Concat);
