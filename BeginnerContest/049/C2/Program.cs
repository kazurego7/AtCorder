...
namespace AtCoderTemplate {
    public class Program {
        public static void Main (string[] args) {
            ...
            var Sr = S.Reverse ();
            while (!Sr.IsEmpty ()) {
                if (Sr.Take (5).SequenceEqual ("dream".Reverse ()) ||
                    Sr.Take (5).SequenceEqual ("erase".Reverse ())) {
                    Sr = Sr.Skip (5);
                    continue;
                } else if (Sr.Take (6).SequenceEqual ("eraser".Reverse ())) {
                    Sr = Sr.Skip (6);
                    continue;
                } else if (Sr.Take (7).SequenceEqual ("dreamer".Reverse ())) {
                    Sr = Sr.Skip (7);
                    continue;
                } else {
                    break;
