...
namespace AtCoderTemplate {
    public class Program {
        public static void Main (string[] args) {
            ...
            var notZeroCount = idCount.Values.Where (count => count != 0).Count ();
            // Print ($"{notZeroCount} {otherCount}");
            // PrintRow (idCount.Values);
            var min = notZeroCount >= 1 ? notZeroCount : 1;
            var max = notZeroCount + otherCount;
